...
const Modal = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="
          fixed  z-10  -top-1/2 translate-y-[50%] mt-10 h-screen w-[350px] md:max-h-[838px] md:w-[1340.8px] overflow-auto
        bg-[#122E3F] text-[#FFFEFA] rounded-2xl md:rounded-[20px] 
      ...
      >
        ...
        <div className="flex flex-col px-4 md:px-[40px] md:py-[26px] gap-9  md:gap-[0px]">
          {/* Intro */}
          ...
          <div className="flex flex-col items-center md:flex-row md:gap-[100px] md:mt-9 md:ml-0">
            ...
            <div className="mt-10 flex flex-col  md:flex-row items-center md:mt-[15px] md:ml-[19px] md:gap-[28px] order-1 ">
              ...
              <div className="mt-8 mb-20 md:m-0 flex items-center  gap-5  md:gap-[18px]  h-full">
                <img
