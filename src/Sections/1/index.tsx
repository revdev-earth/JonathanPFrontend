  ...
  return (
    <div
      className="flex md:items-start  
        ...
        "
    >
      <img src="/section1/rama.png" alt="rama" className="absolute right-0 top-[-10px] md:top-0 w-[210px] md:w-[866px]" />
      ...
      <div className="flex flex-col  gap-3 md:gap-7 max-w-[750px]">
        ...
        <div className="text-[26px] md:text-5xl font-gopher font-bold leading-[30px] md:leading-[54px]" >¡Descubre tu resplandor!</div>
        ...
        <div className=" md:mt-3 py-2 px-2 md:px-5 bg-[#2ABA64] text-base text-center font-bold font-nunito rounded-md tracking-[.15em]" >INVERTIR EN MI CRECIMIENTO</div>
        </div>
      </div>
    </div>
  );
