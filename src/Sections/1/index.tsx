  ...
  return (
    ...
    >
      <img
        ...
        alt="rama"
        className="absolute right-0 top-[-10px] md:top-[-26px] xl:top-0 w-[210px] md:w-[436px] xl:w-[866px]"
      />

      <div className="flex flex-col gap-3 xl:gap-7 max-w-[750px]">
        <div className="w-[253px] md:w-[333px] xl:w-[506px]">
          <img src={LogotFotosintesis} alt="logo fotosintesis" />
        </div>
        <div className="flex flex-col xl:items-start xl:justify-evenly gap-5 xl:gap-3">
          <div className="text-[26px] xl:text-5xl font-gopher font-bold leading-[30px] xl:leading-[54px]">
            ¡Descubre tu resplandor!
          </div>
          <div
            className="font-semibold text-justify md:w-[454px] xl:w-[795px] 
