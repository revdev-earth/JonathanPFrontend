const Section3 = () => {
  return (
    <div className="m-5 md:m-0 mt-8 md:min-h-[800px] bg-[#092435] md:px-24 rounded-lg md:rounded-none py-12 md:py-16  md:pb-8 relative">
      <div>
        <img
      ...
      <div className="flex flex-col items-center  gap-6 md:gap-12 md:pt-0 text-white ">
        ...
        <button className="inline-block uppercase mx-4 md:m-0  md:w-auto px-4 h-10 text-center md:text-base font-nunito border-2 rounded-md border-[#2ABA64] tracking-[.35em]">
          VER PLANES AHORA
        </button>
